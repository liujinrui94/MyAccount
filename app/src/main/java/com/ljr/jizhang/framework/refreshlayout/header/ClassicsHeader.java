...
import com.ljr.jizhang.framework.refreshlayout.internal.ProgressDrawable;
import com.ljr.jizhang.framework.refreshlayout.internal.pathview.PathsDrawable;
...
//    }
    ...
    public ClassicsHeader setCurrentPage(int Page) {
        mLastUpdateText.setText("当前是第"+Page+"页");
        return this;
    }
