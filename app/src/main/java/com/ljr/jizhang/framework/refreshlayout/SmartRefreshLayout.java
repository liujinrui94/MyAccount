package com.ljr.jizhang.framework.refreshlayout;
...
import com.ljr.jizhang.framework.refreshlayout.api.DefaultRefreshFooterCreater;
import com.ljr.jizhang.framework.refreshlayout.api.DefaultRefreshHeaderCreater;
import com.ljr.jizhang.framework.refreshlayout.api.RefreshContent;
import com.ljr.jizhang.framework.refreshlayout.api.RefreshFooter;
import com.ljr.jizhang.framework.refreshlayout.api.RefreshHeader;
import com.ljr.jizhang.framework.refreshlayout.api.RefreshKernel;
import com.ljr.jizhang.framework.refreshlayout.api.RefreshLayout;
import com.ljr.jizhang.framework.refreshlayout.api.RefreshScrollBoundary;
import com.ljr.jizhang.framework.refreshlayout.constant.DimensionStatus;
import com.ljr.jizhang.framework.refreshlayout.constant.RefreshState;
import com.ljr.jizhang.framework.refreshlayout.constant.SpinnerStyle;
import com.ljr.jizhang.framework.refreshlayout.footer.BallPulseFooter;
import com.ljr.jizhang.framework.refreshlayout.header.BezierRadarHeader;
import com.ljr.jizhang.framework.refreshlayout.header.FalsifyHeader;
import com.ljr.jizhang.framework.refreshlayout.impl.RefreshContentWrapper;
import com.ljr.jizhang.framework.refreshlayout.impl.RefreshFooterWrapper;
import com.ljr.jizhang.framework.refreshlayout.impl.RefreshHeaderWrapper;
import com.ljr.jizhang.framework.refreshlayout.listener.OnLoadmoreListener;
import com.ljr.jizhang.framework.refreshlayout.listener.OnMultiPurposeListener;
import com.ljr.jizhang.framework.refreshlayout.listener.OnRefreshListener;
import com.ljr.jizhang.framework.refreshlayout.listener.OnRefreshLoadmoreListener;
import com.ljr.jizhang.framework.refreshlayout.util.DelayedRunable;
import com.ljr.jizhang.framework.refreshlayout.util.DensityUtil;
import com.ljr.jizhang.framework.refreshlayout.util.ViscousFluidInterpolator;
            ...
            public void run() {
                if (mState == RefreshState.Loading) {
                    if (mRefreshFooter != null && mKernel != null && mRefreshContent != null) {
                        ...
                        notifyStateChanged(RefreshState.LoadFinish);
                        ValueAnimator.AnimatorUpdateListener updateListener = mRefreshContent.onLoadingFinish(mKernel, mFooterHeight, startDelay, mReboundDuration);
                        if (mOnMultiPurposeListener != null) {
