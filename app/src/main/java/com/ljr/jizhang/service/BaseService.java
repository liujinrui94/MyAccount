package com.ljr.jizhang.service;
...
import com.ljr.jizhang.model.DownloadCallback;
import com.ljr.jizhang.utils.AppTools;
import com.ljr.jizhang.utils.HttpRequest;
    ...
    public void download(String downloadUrl, String filePath, String fileName, final boolean autoInstall) {
        HttpRequest.download(downloadUrl, filePath, fileName, new DownloadCallback() {
            ...
            public void onDownloadSuccess(File file) {
                ...
                if (autoInstall) {
                    AppTools.installApk(BaseService.this, file);
                }
            }
